...
/**
 * Generated class for the GoshalaPhotoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-goshala-photo',
  templateUrl: 'goshala-photo.html',
})
export class GoshalaPhotoPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad GoshalaPhotoPage');
  }
