...
/**
 * Generated class for the TemplePhotoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-temple-photo',
  templateUrl: 'temple-photo.html',
})
export class TemplePhotoPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad TemplePhotoPage');
  }
