...
/**
/**
 * Generated class for the KundPhotoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-kund-photo',
  templateUrl: 'kund-photo.html',
})
export class KundPhotoPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad KundPhotoPage');
  }
