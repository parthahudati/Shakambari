...
/**
 * Generated class for the DurgaKavachPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-durga-kavach',
  templateUrl: 'durga-kavach.html',
})
export class DurgaKavachPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad DurgaKavachPage');
  }
