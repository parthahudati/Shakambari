...
/**
/**
 * Generated class for the MatajiPhotoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mataji-photo',
  templateUrl: 'mataji-photo.html',
})
export class MatajiPhotoPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad MatajiPhotoPage');
  }
