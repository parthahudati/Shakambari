...
/**
 * Generated class for the JeevanParichayPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-jeevan-parichay',
  templateUrl: 'jeevan-parichay.html',
})
export class JeevanParichayPage {
  ...
  ngOnInit(){
    ...
    this.grid = [[0]] ;
      ...
      this.http.post(url, {
        modulename:"Matajijeevanparichay",
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad JeevanParichayPage');
  }
