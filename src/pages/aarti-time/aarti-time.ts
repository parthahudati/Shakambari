...
/**
/**
 * Generated class for the AartiTimePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-aarti-time',
  templateUrl: 'aarti-time.html',
})
export class AartiTimePage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AartiTimePage');
  }
}
